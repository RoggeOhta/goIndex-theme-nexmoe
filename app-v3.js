...
// 在head 中 加载 必要静态
document.write(
  '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/5MayRain/goIndex-theme-nexmoe@1.1.3/css/mdui_v2.min.css">'
)
document.write(
  '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/5MayRain/goIndex-theme-nexmoe@1.1.6/css/nexmoe_v2.min.css">'
)
document.write(
  '<script src="//cdn.jsdelivr.net/gh/5MayRain/goIndex-theme-nexmoe@1.1.3/js/mdui.min.js"></script>'
)
document.write(
  '<script src="//cdn.jsdelivr.net/gh/5MayRain/goIndex-theme-nexmoe@1.1.5/js/flv.min.js"></script>'
)
document.write(
  '<script src="//cdn.jsdelivr.net/gh/5MayRain/goIndex-theme-nexmoe@1.1.5/js/DPlayer.min.js"></script>'
)
// markdown支持
document.write(
  '<script src="//cdn.jsdelivr.net/gh/5MayRain/goIndex-theme-nexmoe@1.1.3/js/markdown-it.min.js"></script>'
)
document.write(
...
<header class="nexmoe-nav">
  <div class="navSize">
			<a href="/"><img class="avatar" src="https://i.loli.net/2020/09/14/Rjo5gp2MYsG6Wn1.png"/></a>
			<div class="nav_menu">
				<ul class="menu_ul">
...
function title(path) {
  ...
  if (model.is_search_page)
    $("title").html(
      `${document.siteName} - ${drive_name} - 搜索 ${model.q} 的结果`
    )
            ...
            <div class="mdui-container">
                <div class="mdui-row-xs-2 mdui-m-b-1">
                    <div class="mdui-col">
                        ${
                          prev_child
                            ? `<button id="leftBtn" data-filepath="${prev_child}" class="mdui-btn mdui-btn-block mdui-color-theme-accent mdui-ripple">上一张</button>`
                            : `<button class="mdui-btn mdui-btn-block mdui-color-theme-accent mdui-ripple" disabled>上一张</button>`
                        }
                    </div>
                    <div class="mdui-col">
                        ${
                          next_child
                            ? `<button id="rightBtn"  data-filepath="${next_child}" class="mdui-btn mdui-btn-block mdui-color-theme-accent mdui-ripple">下一张</button>`
                            : `<button class="mdui-btn mdui-btn-block mdui-color-theme-accent mdui-ripple" disabled>下一张</button>`
                        }
                    </div> 
                </div>
            </div>
